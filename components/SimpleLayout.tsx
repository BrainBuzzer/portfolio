...
export default function SimpleLayout({ title, intro, children }: SimpleLayoutProps) {
  return (
    <Container className="mt-16 sm:mt-24">
      <header className="max-w-2xl">
        ...
        <p className="mt-6 text-base leading-7 text-zinc-600 dark:text-zinc-400">{intro}</p>
      </header>
